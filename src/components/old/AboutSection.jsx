...
export default function AboutSection() {
  return (
    <section className="bg-white py-20">
      <div className="max-w-screen-xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-start gap-12">
        {/* Text Block */}
        <div className="md:w-1/2">
          <h2 className="text-5xl font-extrabold text-mcbs-navy mb-6">NEWSKI</h2>
        ...
        {/* Image Stack */}
        <div className="relative md:w-1/2 flex justify-center items-center min-h-[400px]">
          <img
            src={image2}
            alt="Top photo"
